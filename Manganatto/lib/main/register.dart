                ...
                child: Form(
                  key: _formKey,
                    ...
                    children: [
                      ...
                      onPressed: () async{
                        if (_formKey.currentState.validate()) {
                          if(_passwordcontroller.text==_confirmpasswordcontroller.text){
                            ...
                            await auth.signUp(context,_emailcontroller.text,_passwordcontroller.text);
                            setState(()=>isloading = !isloading );
                          }else{
                      ...
                      SizedBox(height: 20),
                      Center(child: TextButton(child: Text('Already have an Account? Sign In',style: TextStyle(fontSize: 18.5,color: Colors.white),),onPressed: (){Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => Login()));},),),
                    ],
                  ),
                ),
                ),
